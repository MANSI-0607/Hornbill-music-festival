...
const HeroSection: React.FC = () => {
  ...
  const desktopSrc =
    "https://res.cloudinary.com/dwznqrjgg/image/upload/v1762756812/HMF_25_lc_l6qjf4.jpg"; // 16:9
  const mobileSrc =
    "https://res.cloudinary.com/dwznqrjgg/image/upload/v1762779683/HMF_25_Reel_on2m1n.jpg"; // 9:16
